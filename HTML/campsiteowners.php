      ...
      <div align="right"><a href="add_campsiteowner.php" class="btn btn-success">Add New</a></div>
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <tr class="gradeX">
				  ...
				  <td><a href="campsite_owner_view.php"><i class="icon icon-search"></i> View</a></td>
                </tr>
            ...
            <a href="campsite_owner_view.php"><i class="icon icon-search"></i> View</a>
            ...
            <a href="campsite_owner_view.php"><i class="icon icon-search"></i> View</a>
				 ...
				 <tr class="gradeX">
                  ...
                  <td>Michael@gmail.com </td>
                  <td>(541) 754-3010</td>
                  <td class="center">Active</td> <td>

            <a href="campsite_owner_view.php"><i class="icon icon-search"></i> View</a>

          </td> <a href="campsite_owner_view.php"><i class="icon icon-search"></i> View</a>
                </tr>

...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-envelope"></i> <span class="text">Notifications</span> <span class="label label-important">5</span> <b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a class="sAdd" title="" href="#"><i class="icon-plus"></i> Property Add & Update Notification</a></li>
        <li class="divider"></li>
        <li><a class="sInbox" title="" href="#"><i class="icon-envelope"></i> Booking Notification</a></li>
        <li class="divider"></li>

      </ul>
    </li>
    <li class=""><a title="" href="<?php echo base_url();?>admin/settings"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li>
